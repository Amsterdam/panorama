...
class TestObjectStore(unittest.TestCase):
    ...
    def test_get_pano_csvs(self):
        panorama_csvs = self.object_store.get_csv_type('2016', '03/21/TMX7315120208-000021/', 'panorama')
        self.assertGreater(len(panorama_csvs), 0)
        self.assertEqual('03/21/TMX7315120208-000021/panorama1.csv', panorama_csvs[0]['name'])

    def test_get_trajectory_csvs(self):
        trajectory_csvs = self.object_store.get_csv_type('2016', '03/17/TMX7315120208-000020/', 'trajectory')
        self.assertGreater(len(trajectory_csvs), 0)
        self.assertEqual('03/17/TMX7315120208-000020/trajectory.csv', trajectory_csvs[0]['name'])
    ...
    def test_get_csvs(self):
        ...
        self.assertEqual('03/17/TMX7315120208-000020/panorama1.csv', panorama_csvs[0]['name'])

    def test_get_panorama_store_object(self):
        panorama_csv = self.object_store.get_csv_type('2016', '03/21/TMX7315120208-000021/', 'panorama')[0]
    ...
    def test_get_objects_pages(self):
        ...
        self.assertGreater(len(
            self.object_store.get_datapunt_store_objects('2016'+'/'+big_dir)), 10000)
        #self.object_store.RESP_LIMIT = 1000
        self.assertGreater(len(
            self.object_store.get_panorama_store_objects('2016', '03/21/TMX7315120208-000021')), 2)

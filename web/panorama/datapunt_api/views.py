...
from datasets.panoramas.serializers import PanoSerializer, FileterdPanoSerializer
    ...
    def list(self, request):
        ...
        if coords:
            ...
            try:
                ...
                pano = FileterdPanoSerializer(pano, filter=adjacent_filter, context={'request': request}).data
            except IndexError:
